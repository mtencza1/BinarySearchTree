...
public class BinaryTreeNode<T> {
    ...
    public BinaryTreeNode(T data) { this(data, null, null, null); }
    ...
    public void setParent(BinaryTreeNode<T> parent) { this.parent = parent; }
...
@Override
    public int hashCode() {
        ...
        result = 31 * result + (parent != null ? parent.data.hashCode() : 0);
        result = 31 * result + (right != null ? right.data.hashCode() : 0);
        result = 31 * result + (left != null ? left.data.hashCode() : 0);
        return result;
    }
